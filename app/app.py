...
class MainWindow(QMainWindow):
    ...
    def open_image(self):
        self.file_name = QFileDialog.getOpenFileName(self, "Open Image", "/Users/marco", "Image Files (*.png *.jpg *.bmp)")[0]
    ...
    def predict(self):
        ...
        model_onnx_path = os.path.join(parent_root, "runs", "train", "yolov7", "weights", "yolov7-p6-bonefracture.onnx")
    ...
    def save(self):
        save_file_name = QFileDialog.getSaveFileName(
            self, "Save File", 
            f"/Users/marco/{os.path.basename(self.file_name)}_pred.png", 
            "Images (*.png *.xpm *.jpg)"
        )[0]
