...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.setWindowTitle("Osteo Fracture Identification App")
        ...
        btn_open_img.setIcon(QIcon(os.path.join(parent_root, "dark_mode_icons", "folder.png")))
        ...
        self.btn_predict.setIcon(QIcon(os.path.join(parent_root, "dark_mode_icons", "hand_radiography.png")))
        ...
        self.btn_save.setIcon(QIcon(os.path.join(parent_root, "dark_mode_icons", "diskette.png")))
        ...
        self.btn_clear.setIcon(QIcon(os.path.join(parent_root, "dark_mode_icons", "restart.png")))
        ...
        btn_quit.setIcon(QIcon(os.path.join(parent_root, "dark_mode_icons", "sign-out.png")))
